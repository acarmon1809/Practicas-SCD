...
// 05 nov 25 --> Modificado de LIFO a FIFO usando un búfer circular (según solicitud de actividad)
// -----------------------------------------------------------------------------------
...
class ProdConsSU1 : public HoareMonitor
{
 ...
 int                       // variables permanentes
    ...
    primera_ocupada ,     // MODIFICADO: índice de la próxima celda a leer (consumir)
    primera_libre ,       // MODIFICADO: índice de la próxima celda a escribir (producir)
    num_celdas_ocupadas ; // MODIFICADO: número de celdas ocupadas
...
{
    // MODIFICADO: Inicialización para búfer circular FIFO
    primera_ocupada = 0 ;
    primera_libre = 0 ;
...
{
    // MODIFICADO: Condición de espera para búfer vacío
    ...
    // MODIFICADO: Lógica de lectura FIFO (búfer circular)
...
{
    // MODIFICADO: Condición de espera para búfer lleno
    ...
    // MODIFICADO: Lógica de escritura FIFO (búfer circular)
...
{
    cout << "--------------------------------------------------------------------" << endl
         << "Problema del productor-consumidor únicos (Monitor SU, buffer FIFO). " << endl // MODIFICADO
         << "--------------------------------------------------------------------" << endl
         << flush ;
